...
Public NotInheritable Class MainPanel
    ...
    Private Function BuildSearchSection() As Control
        ...
        Dim heading = CreateSectionHeading("搜索参数", "可在运行前设置 VMAF 目标、范围、采样方式和评测模型")
        layout.Controls.Add(heading, 0, 0)
        layout.SetColumnSpan(heading, 6)

        layout.Controls.Add(CreateSearchField("目标 VMAF", _targetVmaf), 0, 1)
        layout.Controls.Add(CreateSearchField("最小 CRF", _minCrf), 1, 1)
        layout.Controls.Add(CreateSearchField("最大 CRF", _maxCrf), 2, 1)
        layout.Controls.Add(CreateSearchField("采样数量", _samples), 3, 1)
        layout.Controls.Add(CreateSearchField("单段时长", _sampleDuration), 4, 1)
        layout.Controls.Add(_thorough, 5, 1)
        ...
        modelRow.ColumnStyles.Add(New ColumnStyle(SizeType.Absolute, 140))
        modelRow.ColumnStyles.Add(New ColumnStyle(SizeType.Absolute, 300))
        ...
        modelRow.Controls.Add(_refreshModelsButton, 2, 0)
        modelRow.Controls.Add(_browseModelButton, 3, 0)
    ...
    Private Async Function RefreshVmafModelsAsync() As Task
        ...
        Finally
            ...
            If Not IsDisposed Then _refreshModelsButton.Enabled = Not _running
        End Try
    End Function
    ...
    Private Async Function RunQueueItemAsync(item As QueueFileItem,
        ...
        Try
            ...
            item.Row.SubItems(3).Text = result.Vmaf.ToString("0.###", CultureInfo.InvariantCulture)
    ...
    Private Function ReadSearchSettings() As SearchSettings
        ...
        If Not TryParseNumber(_targetVmaf.Text, targetVmaf) Then Throw New FormatException("目标 VMAF 不是有效数字。")
    ...
    Private Sub SetRunning(value As Boolean)
        ...
        _vmafModel.Enabled = Not value
        _refreshModelsButton.Enabled = Not value AndAlso Not _scanningModels
        _browseModelButton.Enabled = Not value
    ...
    Private Shared Function CreateFileList() As UltraDetailListView
        ...
        list.Columns.Add(New UltraDetailListView.ListColumn("VMAF", 90))
